...
_STOPWORDS_TA = {
    ...
    "ஒரு","இந்த","அந்த","இவை","அவை","சில","அனைத்து","ஒவ்வொரு",
    # copulas/particles/conjunctions
    "என்று","எனும்","என","ஆனால்","அல்லது","மேலும்","ஆகவே","எனவே","எனினும்",
    # deictics / pronouns
    "அது","இது","அவன்","அவள்","அவர்கள்","அவை","நான்","நீ","நீங்கள்","நாம்",
    "எவர்","எது","யார்",
    # possessives
    "என்","எங்கள்","உன்",
    # adverbs / function words
    "உள்ள","இப்போது","இன்னும்","மட்டும்","போன்ற","முதல்","வரை",
    "அங்கு","இங்கு","எப்போது","எப்படி","ஏன்","எங்கே",
    # case/postposition-like forms
    "இதில்","அதில்","இவற்றில்","அவற்றில்","இதற்கு","அதற்கு",
    # time/sequence
    "போது","பிறகு","முன்","முன்னர்",
}
